...
class KarlsendRequest extends $pb.GeneratedMessage {
  factory KarlsendRequest({
    $fixnum.Int64? id,
  ...
  KarlsendRequest._() : super();
  factory KarlsendRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory KarlsendRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, KarlsendRequest_Payload> _KarlsendRequest_PayloadByTag = {
    1001 : KarlsendRequest_Payload.getCurrentNetworkRequest,
    1003 : KarlsendRequest_Payload.submitBlockRequest,
    1005 : KarlsendRequest_Payload.getBlockTemplateRequest,
    1007 : KarlsendRequest_Payload.notifyBlockAddedRequest,
    1010 : KarlsendRequest_Payload.getPeerAddressesRequest,
    1012 : KarlsendRequest_Payload.getSinkRequest,
    1014 : KarlsendRequest_Payload.getMempoolEntryRequest,
    1016 : KarlsendRequest_Payload.getConnectedPeerInfoRequest,
    1018 : KarlsendRequest_Payload.addPeerRequest,
    1020 : KarlsendRequest_Payload.submitTransactionRequest,
    1022 : KarlsendRequest_Payload.notifyVirtualChainChangedRequest,
    1025 : KarlsendRequest_Payload.getBlockRequest,
    1027 : KarlsendRequest_Payload.getSubnetworkRequest,
    1029 : KarlsendRequest_Payload.getVirtualChainFromBlockRequest,
    1031 : KarlsendRequest_Payload.getBlocksRequest,
    1033 : KarlsendRequest_Payload.getBlockCountRequest,
    1035 : KarlsendRequest_Payload.getBlockDagInfoRequest,
    1037 : KarlsendRequest_Payload.resolveFinalityConflictRequest,
    1039 : KarlsendRequest_Payload.notifyFinalityConflictRequest,
    1043 : KarlsendRequest_Payload.getMempoolEntriesRequest,
    1045 : KarlsendRequest_Payload.shutdownRequest,
    1047 : KarlsendRequest_Payload.getHeadersRequest,
    1049 : KarlsendRequest_Payload.notifyUtxosChangedRequest,
    1052 : KarlsendRequest_Payload.getUtxosByAddressesRequest,
    1054 : KarlsendRequest_Payload.getSinkBlueScoreRequest,
    1056 : KarlsendRequest_Payload.notifySinkBlueScoreChangedRequest,
    1059 : KarlsendRequest_Payload.banRequest,
    1061 : KarlsendRequest_Payload.unbanRequest,
    1063 : KarlsendRequest_Payload.getInfoRequest,
    1065 : KarlsendRequest_Payload.stopNotifyingUtxosChangedRequest,
    1067 : KarlsendRequest_Payload.notifyPruningPointUtxoSetOverrideRequest,
    1070 : KarlsendRequest_Payload.stopNotifyingPruningPointUtxoSetOverrideRequest,
    1072 : KarlsendRequest_Payload.estimateNetworkHashesPerSecondRequest,
    1074 : KarlsendRequest_Payload.notifyVirtualDaaScoreChangedRequest,
    1077 : KarlsendRequest_Payload.getBalanceByAddressRequest,
    1079 : KarlsendRequest_Payload.getBalancesByAddressesRequest,
    1081 : KarlsendRequest_Payload.notifyNewBlockTemplateRequest,
    1084 : KarlsendRequest_Payload.getMempoolEntriesByAddressesRequest,
    1086 : KarlsendRequest_Payload.getCoinSupplyRequest,
    1088 : KarlsendRequest_Payload.pingRequest,
    1090 : KarlsendRequest_Payload.getMetricsRequest,
    1092 : KarlsendRequest_Payload.getServerInfoRequest,
    1094 : KarlsendRequest_Payload.getSyncStatusRequest,
    1096 : KarlsendRequest_Payload.getDaaScoreTimestampEstimateRequest,
    1100 : KarlsendRequest_Payload.submitTransactionReplacementRequest,
    1102 : KarlsendRequest_Payload.getConnectionsRequest,
    1104 : KarlsendRequest_Payload.getSystemInfoRequest,
    1106 : KarlsendRequest_Payload.getFeeEstimateRequest,
    1108 : KarlsendRequest_Payload.getFeeEstimateExperimentalRequest,
    1110 : KarlsendRequest_Payload.getCurrentBlockColorRequest,
    0 : KarlsendRequest_Payload.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KarlsendRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'protowire'), createEmptyInstance: create)
  ...
  KarlsendRequest clone() => KarlsendRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KarlsendRequest copyWith(void Function(KarlsendRequest) updates) => super.copyWith((message) => updates(message as KarlsendRequest)) as KarlsendRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static KarlsendRequest create() => KarlsendRequest._();
  KarlsendRequest createEmptyInstance() => create();
  static $pb.PbList<KarlsendRequest> createRepeated() => $pb.PbList<KarlsendRequest>();
  @$core.pragma('dart2js:noInline')
  static KarlsendRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KarlsendRequest>(create);
  static KarlsendRequest? _defaultInstance;

  KarlsendRequest_Payload whichPayload() => _KarlsendRequest_PayloadByTag[$_whichOneof(0)]!;
...
class KarlsendResponse extends $pb.GeneratedMessage {
  factory KarlsendResponse({
    $fixnum.Int64? id,
  ...
  KarlsendResponse._() : super();
  factory KarlsendResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory KarlsendResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, KarlsendResponse_Payload> _KarlsendResponse_PayloadByTag = {
    1002 : KarlsendResponse_Payload.getCurrentNetworkResponse,
    1004 : KarlsendResponse_Payload.submitBlockResponse,
    1006 : KarlsendResponse_Payload.getBlockTemplateResponse,
    1008 : KarlsendResponse_Payload.notifyBlockAddedResponse,
    1009 : KarlsendResponse_Payload.blockAddedNotification,
    1011 : KarlsendResponse_Payload.getPeerAddressesResponse,
    1013 : KarlsendResponse_Payload.getSinkResponse,
    1015 : KarlsendResponse_Payload.getMempoolEntryResponse,
    1017 : KarlsendResponse_Payload.getConnectedPeerInfoResponse,
    1019 : KarlsendResponse_Payload.addPeerResponse,
    1021 : KarlsendResponse_Payload.submitTransactionResponse,
    1023 : KarlsendResponse_Payload.notifyVirtualChainChangedResponse,
    1024 : KarlsendResponse_Payload.virtualChainChangedNotification,
    1026 : KarlsendResponse_Payload.getBlockResponse,
    1028 : KarlsendResponse_Payload.getSubnetworkResponse,
    1030 : KarlsendResponse_Payload.getVirtualChainFromBlockResponse,
    1032 : KarlsendResponse_Payload.getBlocksResponse,
    1034 : KarlsendResponse_Payload.getBlockCountResponse,
    1036 : KarlsendResponse_Payload.getBlockDagInfoResponse,
    1038 : KarlsendResponse_Payload.resolveFinalityConflictResponse,
    1040 : KarlsendResponse_Payload.notifyFinalityConflictResponse,
    1041 : KarlsendResponse_Payload.finalityConflictNotification,
    1042 : KarlsendResponse_Payload.finalityConflictResolvedNotification,
    1044 : KarlsendResponse_Payload.getMempoolEntriesResponse,
    1046 : KarlsendResponse_Payload.shutdownResponse,
    1048 : KarlsendResponse_Payload.getHeadersResponse,
    1050 : KarlsendResponse_Payload.notifyUtxosChangedResponse,
    1051 : KarlsendResponse_Payload.utxosChangedNotification,
    1053 : KarlsendResponse_Payload.getUtxosByAddressesResponse,
    1055 : KarlsendResponse_Payload.getSinkBlueScoreResponse,
    1057 : KarlsendResponse_Payload.notifySinkBlueScoreChangedResponse,
    1058 : KarlsendResponse_Payload.sinkBlueScoreChangedNotification,
    1060 : KarlsendResponse_Payload.banResponse,
    1062 : KarlsendResponse_Payload.unbanResponse,
    1064 : KarlsendResponse_Payload.getInfoResponse,
    1066 : KarlsendResponse_Payload.stopNotifyingUtxosChangedResponse,
    1068 : KarlsendResponse_Payload.notifyPruningPointUtxoSetOverrideResponse,
    1069 : KarlsendResponse_Payload.pruningPointUtxoSetOverrideNotification,
    1071 : KarlsendResponse_Payload.stopNotifyingPruningPointUtxoSetOverrideResponse,
    1073 : KarlsendResponse_Payload.estimateNetworkHashesPerSecondResponse,
    1075 : KarlsendResponse_Payload.notifyVirtualDaaScoreChangedResponse,
    1076 : KarlsendResponse_Payload.virtualDaaScoreChangedNotification,
    1078 : KarlsendResponse_Payload.getBalanceByAddressResponse,
    1080 : KarlsendResponse_Payload.getBalancesByAddressesResponse,
    1082 : KarlsendResponse_Payload.notifyNewBlockTemplateResponse,
    1083 : KarlsendResponse_Payload.newBlockTemplateNotification,
    1085 : KarlsendResponse_Payload.getMempoolEntriesByAddressesResponse,
    1087 : KarlsendResponse_Payload.getCoinSupplyResponse,
    1089 : KarlsendResponse_Payload.pingResponse,
    1091 : KarlsendResponse_Payload.getMetricsResponse,
    1093 : KarlsendResponse_Payload.getServerInfoResponse,
    1095 : KarlsendResponse_Payload.getSyncStatusResponse,
    1097 : KarlsendResponse_Payload.getDaaScoreTimestampEstimateResponse,
    1101 : KarlsendResponse_Payload.submitTransactionReplacementResponse,
    1103 : KarlsendResponse_Payload.getConnectionsResponse,
    1105 : KarlsendResponse_Payload.getSystemInfoResponse,
    1107 : KarlsendResponse_Payload.getFeeEstimateResponse,
    1109 : KarlsendResponse_Payload.getFeeEstimateExperimentalResponse,
    1111 : KarlsendResponse_Payload.getCurrentBlockColorResponse,
    0 : KarlsendResponse_Payload.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KarlsendResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'protowire'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  KarlsendResponse clone() => KarlsendResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KarlsendResponse copyWith(void Function(KarlsendResponse) updates) => super.copyWith((message) => updates(message as KarlsendResponse)) as KarlsendResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static KarlsendResponse create() => KarlsendResponse._();
  KarlsendResponse createEmptyInstance() => create();
  static $pb.PbList<KarlsendResponse> createRepeated() => $pb.PbList<KarlsendResponse>();
  @$core.pragma('dart2js:noInline')
  static KarlsendResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KarlsendResponse>(create);
  static KarlsendResponse? _defaultInstance;

  KarlsendResponse_Payload whichPayload() => _KarlsendResponse_PayloadByTag[$_whichOneof(0)]!;
  void clearPayload() => clearField($_whichOneof(0));
